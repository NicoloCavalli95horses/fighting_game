...
const players_boxes = [
  {
    id: 1,
    src: "../public/img/characters/samuraiMack/preview.png",
    zoom: "400%",
    position: "50% 75%",
  },
  {
    id: 2,
    src: "../public/img/characters/kenji/preview.png",
    zoom: "450%",
    position: "52% 74%",
  },
  {
    id: 3,
    src: "../public/img/characters/kunoichi/preview.png",
    zoom: "400%",
    position: "47% 64%",
  },
  {
    id: 4,
    src: "../public/img/characters/toriotoko/preview.png",
    zoom: "350%",
    position: "47% 39%",
  }
];
